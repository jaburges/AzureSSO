...
(function($) {
    ...
    function addEmailBlocks() {
        ...
        // Modern SVG icons with explicit colors (grey #606770, hover via CSS)
        var iconColor = '#606770';
        var icons = {
            section: '<svg viewBox="0 0 24 24" width="36" height="36"><rect x="2" y="4" width="20" height="16" rx="2" fill="none" stroke="' + iconColor + '" stroke-width="1.5"/><line x1="2" y1="10" x2="22" y2="10" stroke="' + iconColor + '" stroke-width="1.5"/></svg>',
            columns2: '<svg viewBox="0 0 24 24" width="36" height="36"><rect x="2" y="4" width="9" height="16" rx="1" fill="none" stroke="' + iconColor + '" stroke-width="1.5"/><rect x="13" y="4" width="9" height="16" rx="1" fill="none" stroke="' + iconColor + '" stroke-width="1.5"/></svg>',
            columns3: '<svg viewBox="0 0 24 24" width="36" height="36"><rect x="1" y="4" width="6" height="16" rx="1" fill="none" stroke="' + iconColor + '" stroke-width="1.5"/><rect x="9" y="4" width="6" height="16" rx="1" fill="none" stroke="' + iconColor + '" stroke-width="1.5"/><rect x="17" y="4" width="6" height="16" rx="1" fill="none" stroke="' + iconColor + '" stroke-width="1.5"/></svg>',
            text: '<svg viewBox="0 0 24 24" width="36" height="36"><line x1="3" y1="6" x2="21" y2="6" stroke="' + iconColor + '" stroke-width="2" stroke-linecap="round"/><line x1="3" y1="10" x2="18" y2="10" stroke="' + iconColor + '" stroke-width="2" stroke-linecap="round"/><line x1="3" y1="14" x2="21" y2="14" stroke="' + iconColor + '" stroke-width="2" stroke-linecap="round"/><line x1="3" y1="18" x2="12" y2="18" stroke="' + iconColor + '" stroke-width="2" stroke-linecap="round"/></svg>',
            heading: '<svg viewBox="0 0 24 24" width="36" height="36"><text x="4" y="18" font-family="Arial" font-size="16" font-weight="bold" fill="' + iconColor + '">H1</text></svg>',
            image: '<svg viewBox="0 0 24 24" width="36" height="36"><rect x="2" y="4" width="20" height="16" rx="2" fill="none" stroke="' + iconColor + '" stroke-width="1.5"/><circle cx="8" cy="10" r="2" fill="' + iconColor + '"/><path d="M22 16l-5-5-3 3-4-4-8 8" fill="none" stroke="' + iconColor + '" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            button: '<svg viewBox="0 0 24 24" width="36" height="36"><rect x="3" y="8" width="18" height="8" rx="4" fill="' + iconColor + '" opacity="0.15"/><rect x="3" y="8" width="18" height="8" rx="4" fill="none" stroke="' + iconColor + '" stroke-width="1.5"/><line x1="8" y1="12" x2="16" y2="12" stroke="' + iconColor + '" stroke-width="2" stroke-linecap="round"/></svg>',
            divider: '<svg viewBox="0 0 24 24" width="36" height="36"><line x1="2" y1="12" x2="22" y2="12" stroke="' + iconColor + '" stroke-width="2" stroke-linecap="round"/></svg>',
            spacer: '<svg viewBox="0 0 24 24" width="36" height="36"><line x1="12" y1="4" x2="12" y2="20" stroke="' + iconColor + '" stroke-width="1.5" stroke-dasharray="2 2"/><path d="M8 7l4-3 4 3" fill="none" stroke="' + iconColor + '" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M8 17l4 3 4-3" fill="none" stroke="' + iconColor + '" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            header: '<svg viewBox="0 0 24 24" width="36" height="36"><rect x="2" y="3" width="20" height="8" rx="1" fill="' + iconColor + '" opacity="0.15"/><rect x="2" y="3" width="20" height="8" rx="1" fill="none" stroke="' + iconColor + '" stroke-width="1.5"/><rect x="7" y="5" width="10" height="4" rx="1" fill="' + iconColor + '" opacity="0.3"/><rect x="2" y="13" width="20" height="8" rx="1" fill="none" stroke="' + iconColor + '" stroke-width="1.5" stroke-dasharray="2 2"/></svg>',
            footer: '<svg viewBox="0 0 24 24" width="36" height="36"><rect x="2" y="3" width="20" height="8" rx="1" fill="none" stroke="' + iconColor + '" stroke-width="1.5" stroke-dasharray="2 2"/><rect x="2" y="13" width="20" height="8" rx="1" fill="' + iconColor + '" opacity="0.15"/><rect x="2" y="13" width="20" height="8" rx="1" fill="none" stroke="' + iconColor + '" stroke-width="1.5"/><line x1="6" y1="17" x2="18" y2="17" stroke="' + iconColor + '" stroke-width="1.5" stroke-linecap="round"/></svg>',
            social: '<svg viewBox="0 0 24 24" width="36" height="36"><circle cx="6" cy="12" r="3" fill="none" stroke="' + iconColor + '" stroke-width="1.5"/><circle cx="12" cy="12" r="3" fill="none" stroke="' + iconColor + '" stroke-width="1.5"/><circle cx="18" cy="12" r="3" fill="none" stroke="' + iconColor + '" stroke-width="1.5"/></svg>',
            user: '<svg viewBox="0 0 24 24" width="36" height="36"><circle cx="12" cy="8" r="4" fill="none" stroke="' + iconColor + '" stroke-width="1.5"/><path d="M4 20c0-4 4-6 8-6s8 2 8 6" fill="none" stroke="' + iconColor + '" stroke-width="1.5" stroke-linecap="round"/></svg>',
            email: '<svg viewBox="0 0 24 24" width="36" height="36"><rect x="2" y="5" width="20" height="14" rx="2" fill="none" stroke="' + iconColor + '" stroke-width="1.5"/><path d="M2 7l10 6 10-6" fill="none" stroke="' + iconColor + '" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            link: '<svg viewBox="0 0 24 24" width="36" height="36"><path d="M10 14a4 4 0 005.66 0l3-3a4 4 0 00-5.66-5.66l-1 1" fill="none" stroke="' + iconColor + '" stroke-width="1.5" stroke-linecap="round"/><path d="M14 10a4 4 0 00-5.66 0l-3 3a4 4 0 005.66 5.66l1-1" fill="none" stroke="' + iconColor + '" stroke-width="1.5" stroke-linecap="round"/></svg>',
            browser: '<svg viewBox="0 0 24 24" width="36" height="36"><rect x="2" y="4" width="20" height="16" rx="2" fill="none" stroke="' + iconColor + '" stroke-width="1.5"/><line x1="2" y1="9" x2="22" y2="9" stroke="' + iconColor + '" stroke-width="1.5"/><circle cx="5" cy="6.5" r="1" fill="' + iconColor + '"/><circle cx="8" cy="6.5" r="1" fill="' + iconColor + '"/><circle cx="11" cy="6.5" r="1" fill="' + iconColor + '"/></svg>'
        };
