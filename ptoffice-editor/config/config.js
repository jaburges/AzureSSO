// Configuration for PTA Office Content Editor

const APP_CONFIG = {
    // Azure AD Configuration
    azure: {
        clientId: 'YOUR_AZURE_CLIENT_ID', // Same as WordPress Azure SSO plugin
        authority: 'https://login.microsoftonline.com/YOUR_TENANT_ID', // Replace YOUR_TENANT_ID
        redirectUri: window.location.origin + '/ptoffice-editor/', // Update to match your domain
...
if (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1') {
    ...
    APP_CONFIG.azure.redirectUri = 'http://localhost:8080/ptoffice-editor/';
    APP_CONFIG.wordpress.baseUrl = 'https://wilderptsa.net'; // Still use production WordPress
    APP_CONFIG.wordpress.apiBase = 'https://wilderptsa.net/wp-json/wp/v2';
    APP_CONFIG.wordpress.mediaApi = 'https://wilderptsa.net/wp-json/wp/v2/media';
    APP_CONFIG.ui.showAdvancedOptions = true; // Show more options in development
}

// Helper function to get full WordPress URL
...
// Helper function to get media API URL
